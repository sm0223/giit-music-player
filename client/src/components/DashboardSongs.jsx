      ...
      <div className="w-full p-4 flex items-center justify-center flex-col">
        <div className="w-full flex justify-center items-center gap-10">
          <NavLink
              ...
              className="flex items-center px-4 py-3 rounded-full text-textColor bg-zinc-800 hover:bg-zinc-950 hover:shadow-md cursor-pointer"
          >
            <IoAdd />
          </NavLink>
          <input
        ...
        <div className="relative w-full  my-4 p-4 py-12 bg-zinc-800 rounded-sm">
...
export const SongCard = ({ data, index }) => {
  ...
  return (
      <motion.div
          ...
          className="relative w-40 min-w-210 px-2 py-4 cursor-pointer hover:shadow-xl hover:bg-gray-200 bg-gray-100 shadow-md rounded-lg flex flex-col items-center"
