...
const MusicPlayer = () => {
  ...
  return (
      <div className="w-full bg-zinc-800 full flex items-center gap-3 overflow-hidden">
        <div
        ...
        >
          ...
          <div className="flex-1">
            <AudioPlayer
                ...
                style={{backgroundColor:"#000000", color:"#fcfcfc"}}
            />
          </div>
          <div className="h-full flex items-center justify-center flex-col gap-3">
            <motion.i whileTap={{ scale: 0.8 }} onClick={closeMusicPlayer}>
              <IoMdClose className="text-textColor hover:text-gray-400 text-2xl cursor-pointer" />
            </motion.i>
            <motion.i whileTap={{ scale: 0.8 }} onClick={togglePlayer}>
              <IoArrowRedo className="text-textColor hover:text-gray-400 text-2xl cursor-pointer" />
            </motion.i>
          </div>
        </div>
...
export const PlayListCard = () => {
  ...
  return (
      <div className="absolute left-4 bottom-24 gap-2 py-2 w-350 max-w-[350px]
      h-510 max-h-[510px] flex flex-col overflow-y-scroll scrollbar-thin rounded-md shadow-md bg-primary">
        {allSongs.length > 0 ? (
